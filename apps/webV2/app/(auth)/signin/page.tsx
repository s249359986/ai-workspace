...
export default function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 模拟网络请求延迟
      const res = await fetch('/api/auth/login', { // 如果重命名了路由，改为 /api/auth/login
        method: 'POST',
        headers: {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            {/* Google Sign In Button (Keep as is or add logic later) */}
            <form>
              <div className="flex flex-wrap -mx-3">
                <div className="w-full px-3">
                  <button type="button" className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
